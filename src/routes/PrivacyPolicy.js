		...
		<div className="container">
            ...
            <div>
                <dl>
                    ...
                    <dd>- 성 명: 임정택</dd>
                    <dd>- 직 책: Co-Founder</dd>
                    <dd>- 연락처: wjdxor6346@naver.com</dd>
                    ...
                    <dd>이 개인정보처리방침은 2020.03.12 부터 적용되며, 법령 및 방침에 따른 변경내용의 추가, 삭제 및 정정이 있는 경우에는 변경사항의 시행 7일 전부터 공지사항을 통하여 고지할 것입니다.</dd>
